...
///
/// <para><b>Enriquecimiento aditivo (Story 5.3, party-mode opción a).</b> <see cref="HuespedEmail"/> es el
/// destinatario del correo de resolución (el viajero). Aditivo (E5 es el primer consumidor) y nullable por
/// fidelidad al dominio; el consumidor omite el envío si es nulo. La resolución solo se notifica al viajero (AC).</para>
/// </summary>
public sealed record ReservaCanceladaV1(
    ...
    string? HuespedEmail = null)          // destinatario del correo de resolución (viajero); ver summary.
{
